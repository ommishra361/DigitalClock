...
timer_running = False
def clock():
        date_time = datetime.datetime.now().strftime("%A-%d-%m-%y %H:%M:%S/%p")
...
time_label = Label(clock_tab, font = 'calibri 60 bold', foreground = 'gold')
time_label.pack(anchor='center')
date_label = Label(clock_tab, font = 'calibri 60 bold', foreground = 'gold')
...
stopwatch_label = Label(stopwatch_tab, font='calibri 40 bold', text='Stopwatch', foreground='silver')
...
timer_label = Label(timer_tab, font='calibri 40 bold', text='Timer', foreground='silver')
